const { loginUser, registerUser, getPublicKey, getPasswordLogin, refreshToken, logoutUser, changePassword, forgotPassword, resetPassword, userProfile } = require('../controllers/authController')

const RouterAuth = (path, router) => {
    router
    .post(path + '/register', registerUser)
